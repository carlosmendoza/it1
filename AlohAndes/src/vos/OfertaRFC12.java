...
public class OfertaRFC12 {
	...
	public OfertaRFC12(@JsonProperty(value="id") int id , @JsonProperty(value="idOperador") int idOperador,@JsonProperty(value="capacidadReal") int capacidadReal,
			@JsonProperty(value="costo") double costo, 
	@JsonProperty(value="disponibilidad") int disponibilidad, @JsonProperty(value="numeroSemana2") int numeroSemana2 )
	{
		this.id = id;
		this.costo = costo;
